...
import { TITLE_WITH_CONTENT, TYPE_TEST_LIST } from '../../constants/constant'

function TitleWithText(props) {
  const cn_1 = props.type_1 === TITLE_WITH_CONTENT ? `${styles.title} ${styles.withContent}` : `${styles.title}`
  const cn_2 = props.type_2 === TYPE_TEST_LIST ? `${styles.content} ${styles.marginBottom}` : `${styles.content}`
  return (
    <div>
